...
while ($linha = $resultado->fetch(PDO::FETCH_ASSOC)) {
    echo '<section class="area-login">';
        echo '<div class="formulario">';
            echo '<form action="paciente-edita-bd.php" method="post">';
                ...
                echo '<input type="text" name="cpf" id="cpf" placeholder="Digite o CPF" required value="'. $linha["cpf"] . '"><br>';

                echo '<label for="telefone">Telefone</label>';
                echo '<input type="text" name="telefone" id="tel" placeholder="Digite o telefone" required value="'. $linha["telefone"] . '"><br>';

                echo '<input type="submit" value="Atualizar" name="editaPaciente">';
            echo '</form>';
        echo '</div>';
    echo '</section>';
}
