...
<body>
    ...
    $result_consulta_cont = "SELECT * FROM consulta WHERE estado = 'Realizada' OR estado = 'Cancelada' ORDER BY data_consulta DESC";
                    ...
                    if (($resultado_consulta_cont) and ($resultado_consulta_cont->rowCount() != 0)) {
                        ...
                        while ($row_consulta_cont = $resultado_consulta_cont->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo '<tr>';
                                ...
                                echo "<td><a href='historico-edita.php?id=" . $row_consulta_cont['id'] . "'>Editar&nbsp&nbsp&nbsp&nbsp</a>";
                                echo "<a href='historico-apaga.php?id=" . $row_consulta_cont['id'] . "'>Apagar</a></td>";
                            echo '</tr>';
                        }
                    } 
                    else {
                        echo '<h3>Não há consultas realizadas ou canceladas!</h3><br>';
                    }
                }
            echo '</table>';
        echo '</div>';
